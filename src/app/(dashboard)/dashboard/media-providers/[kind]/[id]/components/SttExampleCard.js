        ...
        <Row label="Audio File">
          <div className="flex flex-col gap-2">
            <input
              ...
              className="w-full text-xs text-text-muted file:mr-2 file:py-1 file:px-2.5 file:rounded-lg file:border file:border-border file:bg-surface file:text-text-main hover:file:bg-sidebar file:cursor-pointer"
            />
            {audioFile && (
