          ...
          {config.hasModelSelector && (config.modelKey || getModelsByProviderId(providerId).some(m => getModelKind(m) === "tts")) && (
            <Row label="Model">
              <select
                ...
                className="w-full px-3 py-1.5 text-sm border border-border rounded-lg bg-surface focus:outline-none focus:border-primary"
              >
                {(() => {
          ...
          {config.hasBrowseButton && (
            <Row label="Language">
              <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                <button
                  onClick={openModal}
                  className="w-full min-w-0 flex-1 px-3 py-1.5 text-sm border border-border rounded-lg bg-surface font-mono truncate text-left hover:border-primary/40 transition-colors"
                >
                  {selectedLang
              ...
              <div className="flex flex-col gap-1">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-1.5 pr-7 text-sm border border-border rounded-lg bg-surface focus:outline-none focus:border-primary font-mono"
                  />
                  {voiceId && (
                    <button
                      type="button"
          ...
          <Row label="Input">
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-1.5 pr-7 text-sm border border-border rounded-lg bg-surface focus:outline-none focus:border-primary"
              />
              {input && (
                <button
                  type="button"
            ...
            <Row label={translate("Style")}>
              <div className="relative">
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-1.5 pr-7 text-sm border border-border rounded-lg bg-surface focus:outline-none focus:border-primary resize-none"
                />
                {style && (
                  <button
                    type="button"
